...
//
//@objc(ReactNativeTRTC)
//class ReactNativeTRTC: NSObject {
...
//     */
//    func enterRoom(_ param: TRTCParams!, appScene scene: TRTCAppScene){
//        self.trtcCloud.enterRoom(param, appScene: scene)
//    }
//    
//    
//    /**
...
//     */
//    func `switch`(_ role: TRTCRoleType){
...
//     *
//     **/
//    func connectOtherRoom(_ param: String!){
...
//     * @note 需要在进房前设置才能生效。
//     **/
//    func setDefaultStreamRecvMode(_ autoRecvAudio: Bool, video autoRecvVideo: Bool){
...
//     */
//    func startPublishing(_ streamId: String!, type: TRTCVideoStreamType){
...
//     */
//    func startPublishCDNStream(_ param: TRTCPublishCDNParam!){
...
//     */
//    func setMix(_ config: TRTCTranscodingConfig!){
//        self.trtcCloud.setMix(config)
//    }
//    
//    
//    /// @}
...
//     */
//    func startLocalPreview(_ frontCamera: Bool, view: UIView!){
...
//     * @param view 承载视频画面的控件
//     */
//    func startRemoteView(_ userId: String!, view: UIView!){
//        self.trtcCloud.startRemoteView(userId, view: view)
//    }
//    
//    
//    /**
...
//     * @param userId 对方的用户标识
//     */
//    func stopRemoteView(_ userId: String!){
...
//     * @param mute  是否暂停接收
//     */
//    func muteRemoteVideoStream(_ userId: String!, mute: Bool){
...
//     * @param mute 是否暂停接收
//     */
//    func muteAllRemoteVideoStreams(_ mute: Bool){
...
//     */
//    func setNetworkQosParam(_ param: TRTCNetworkQosParam!){
...
//     */
//    func setLocalViewFillMode(_ mode: TRTCVideoFillMode){
...
//     * @param mode 填充（画面可能会被拉伸裁剪）或适应（画面可能会有黑边），默认值：TRTCVideoFillMode_Fill
//     */
//    func setRemoteViewFillMode(_ userId: String!, mode: TRTCVideoFillMode){
...
//     */
//    func setLocalViewRotation(_ rotation: TRTCVideoRotation){
...
//     * @param rotation 支持90、180以及270旋转角度，默认值：TRTCVideoRotation_0
//     */
//    func setRemoteViewRotation(_ userId: String!, rotation: TRTCVideoRotation){
...
//     */
//    func setVideoEncoderRotation(_ rotation: TRTCVideoRotation){
...
//     */
//    func setLocalViewMirror(_ mirror: TRTCLocalVideoMirrorType){
...
//     */
//    func setVideoEncoderMirror(_ mirror: Bool){
...
//     */
//    func setGSensorMode(_ mode: TRTCGSensorMode){
...
//     */
//    func enableEncSmallVideoStream(_ enable: Bool, withQuality smallVideoEncParam: TRTCVideoEncParam!, resolve: RCTPromiseResolveBlock, reject:RCTPromiseRejectBlock) {
//        if self.trtcCloud.enableEncSmallVideoStream(enable, withQuality: smallVideoEncParam)==0{
//            resolve(nil)
//        }else{
//            reject("大画面已经是最低画质", "-1", nil);
//        }
//    }
//    
//    
...
//     */
//    func setRemoteVideoStreamType(_ userId: String!, type: TRTCVideoStreamType){
...
//     */
//    func setPriorRemoteVideoStreamType(_ type: TRTCVideoStreamType){}
//    
//    
//    /**
//     * 3.23 视频画面截图
...
//     */
//    func snapshotVideo(_ userId: String!, type: TRTCVideoStreamType, completionBlock: ((UIImage?) -> Void)!){}
//    
//    
//    /// @}
//    
...
//     */
//    func setAudioRoute(_ route: TRTCAudioRoute){}
//    
//    
//    /**
...
//     */
//    func muteRemoteAudio(_ userId: String!, mute: Bool){}
//    
//    
//    /**
//     * 4.6 静音/取消静音所有用户的声音
...
//     */
//    func setRemoteAudioVolume(_ userId: String!, volume: Int32){}
//    
//    
//    /**
//     * 4.8 设置 SDK 采集音量。
...
//     */
//    func setAudioCaptureVolume(_ volume: Int){}
//    
//    
//    /**
//     * 4.9 获取 SDK 采集音量
//     */
//    func getAudioCaptureVolume() -> Int{}
//    
//    
//    /**
//     * 4.10 设置 SDK 播放音量。
...
//     * @param volume 音量大小，取值0 - 100，默认值为100
//     */
//    func setAudioPlayoutVolume(_ volume: Int)
//    
//    
//    /**
//     * 4.11 获取 SDK 播放音量
//     */
//    func getAudioPlayoutVolume() -> Int
//    
//    
//    /**
//     * 4.12 启用音量大小提示
...
//     */
//    func enableAudioVolumeEvaluation(_ interval: UInt){
//        
//    }
//    
//    
...
//     */
//    func startAudioRecording(_ param: TRTCAudioRecordingParams!) -> Int32
//    
//    
//    /**
//     * 4.14 停止录音
...
//     */
//    func setSystemVolumeType(_ type: TRTCSystemVolumeType){}
//    
//    
//    /**
//     * 4.16 开启耳返
...
//     */
//    func enableAudioEarMonitoring(_ enable: Bool){
...
//     */
//    func setZoom(_ distance: CGFloat){}
//    
//    
//    /**
...
//     * @param enable YES：开启；NO：关闭，默认值：NO
//     */
//    func enbaleTorch(_ enable: Bool) -> Bool
//    
//    
//    /**
//     * 5.6 查询是否支持设置焦点
...
//     */
//    func setFocusPosition(_ touchPoint: CGPoint){}
//    
//    
//    /**
//     * 5.8 查询是否支持自动识别人脸位置
...
//     */
//    func enableAutoFaceFoucs(_ enable: Bool){}
//    
//    
//    /**
//     * 5.10 获取摄像头设备列表
...
//     */
//    func setWatermark(_ image: UIImage!, streamType: TRTCVideoStreamType, rect: CGRect){}
//    
//    
//    /// @}
//    
...
//     */
//    @available(iOS 13.0, *)
//    func startScreenCapture(_ encParams: TRTCVideoEncParam!){}
//    
//    
//    /**
//     * 8.1 启动屏幕分享（Mac）
...
//     */
//    @available(iOS 13.0, *)
//    func resumeScreenCapture() -> Int32
//    
//    
//    /**
...
//     */
//    func startRemoteSubStreamView(_ userId: String!, view: UIView!){}
//    
//    
//    /**
...
//     * @param userId 对方的用户标识
//     */
//    func stopRemoteSubStreamView(_ userId: String!){}
//    
//    
//    /**
...
//     */
//    func setRemoteSubStreamViewFillMode(_ userId: String!, mode: TRTCVideoFillMode)
//    
//    
//    /**
...
//     */
//    func setRemoteSubStreamViewRotation(_ userId: String!, rotation: TRTCVideoRotation){}
//    
//    
//    /**
...
//     */
//    func enableCustomVideoCapture(_ enable: Bool){}
//    
//    
//    /**
...
//     *
//     */
//    func sendCustomVideoData(_ frame: TRTCVideoFrame!){}
//    
//    
//    /**
//     * 9.3 设置本地视频的自定义渲染回调
...
//     * @return 0：成功；<0：错误
//     */
//    func setLocalVideoRenderDelegate(_ delegate: TRTCVideoRenderDelegate!, pixelFormat: TRTCVideoPixelFormat, bufferType: TRTCVideoBufferType) -> Int32
//    
//    
//    /**
//     * 9.4 设置远端视频的自定义渲染回调
...
//     * @return 0：成功；<0：错误
//     */
//    func setRemoteVideoRenderDelegate(_ userId: String!, delegate: TRTCVideoRenderDelegate!, pixelFormat: TRTCVideoPixelFormat, bufferType: TRTCVideoBufferType) -> Int32
//    
//    
//    /**
//     * 9.5 启用音频自定义采集模式
...
//     */
//    func enableCustomAudioCapture(_ enable: Bool){}
//    
//    
//    /**
...
//     */
//    func sendCustomAudioData(_ frame: TRTCAudioFrame!){}
//    
//    
//    /**
//     * 9.7 设置音频数据回调
...
//     */
//    func setAudioFrameDelegate(_ delegate: TRTCAudioFrameDelegate!){}
//    
//    
//    /// @}
//    
...
//     */
//    func sendSEIMsg(_ data: Data!, repeatCount: Int32) -> Bool
//    
//    
//    /// @}
//    
...
//     */
//    func playBGM(_ path: String!, withBeginNotify beginNotify: ((Int) -> Void)!, withProgressNotify progressNotify: ((Int, Int) -> Void)!, andCompleteNotify completeNotify: ((Int) -> Void)!)
//    
//    
//    /**
//     * 11.2 停止播放背景音乐
...
//     */
//    func getBGMDuration(_ path: String!) -> Int
//    
//    
//    /**
//     * 11.6 设置 BGM 播放进度
...
//     * @return 0：成功；-1：失败
//     */
//    func setBGMPosition(_ pos: Int) -> Int32
//    
//    
//    /**
//     * 11.7 设置背景音乐播放音量的大小
...
//     * @param volume 音量大小，100为正常音量，取值范围为0 - 100；默认值：100
//     */
//    func setBGMPlayoutVolume(_ volume: Int){}
//    
//    
//    /**
...
//     * @param volume 音量大小，100为正常音量，取值范围为0 - 100；默认值：100
//     */
//    func setBGMPublishVolume(_ volume: Int){}
//    
//    
//    /**
...
//     */
//    func setReverbType(_ reverbType: TRTCReverbType){}
//    
//    
//    /**
...
//     */
//    func setVoiceChangerType(_ voiceChangerType: TRTCVoiceChangerType){}
//    
//    /// @}
//    
//    /////////////////////////////////////////////////////////////////////////////////
...
//     * @param effect 音效
//     */
//    func playAudioEffect(_ effect: TRTCAudioEffectParam!){}
//    
//    
//    /**
//     * 12.2 设置音效音量
...
//     */
//    func setAudioEffectVolume(_ effectId: Int32, volume: Int32){}
//    
//    
//    /**
//     * 12.3 停止音效
...
//     * @param effectId 音效 ID
//     */
//    func stopAudioEffect(_ effectId: Int32){}
//    
//    
//    /**
//     * 12.4 停止所有音效
//     */
//    func stopAllAudioEffects(){}
//    
//    
//    /**
//     * 12.5 设置所有音效音量
...
//     * @param volume 音量大小，取值范围为0 - 100；默认值：100
//     */
//    func setAllAudioEffectsVolume(_ volume: Int32){}
//    
//    
//    /**
//     * 12.6 暂停音效
...
//     * @param effectId 音效 ID
//     */
//    func pauseAudioEffect(_ effectId: Int32){}
//    
//    
//    /**
//     * 12.7 恢复音效
...
//     * @param effectId 音效 ID
//     */
//    func resumeAudioEffect(_ effectId: Int32){}
//    
//    /// @}
//    
//    /////////////////////////////////////////////////////////////////////////////////
...
//     */
//    func startSpeedTest(_ sdkAppId: UInt32, userId: String!, userSig: String!, completion: ((TRTCSpeedTestResult?, Int, Int) -> Void)!){}
//    
//    
//    /**
//     * 13.2 停止服务器测速
...
//     */
//    open class func setLogLevel(_ level: TRTCLogLevel){}
//    
//    
//    /**
//     * 14.3 启用或禁用控制台日志打印
...
//     */
//    open class func setConsoleEnabled(_ enabled: Bool){}
//    
//    
//    /**
...
//     */
//    open class func setLogCompressEnabled(_ enabled: Bool){}
//    
//    
//    /**
//     * 14.5 修改日志保存路径
...
//     * @param path 存储日志路径
//     */
//    open class func setLogDirPath(_ path: String!){}
//    
//    
//    /**
//     * 14.6 设置日志回调
//     */
//    open class func setLogDelegate(_ logDelegate: TRTCLogDelegate!){}
//    
//    
//    /**
//     * 14.7 显示仪表盘
...
//     */
//    func showDebugView(_ showType: Int){}
//    
//    
//    /**
//     * 14.8 设置仪表盘的边距
...
//     */
//    func setDebugViewMargin(_ userId: String!, margin: TXEdgeInsets){}
//    
//    
//    /**
//     * 14.9 调用实验性 API 接口
...
//     */
//    func callExperimentalAPI(_ jsonStr: String!){}
//    
//    
//    /// @}
//    
...
//     * @param volume 音量大小，100为正常音量，取值范围为0 - 100；默认值：100
//     */
//    @available(*, deprecated, message: "use setAudioCaptureVolume instead")
//    func setMicVolumeOnMixing(_ volume: Int){}
//    
//    
//    /**
...
//     */
//    @available(*, deprecated, message: "use getBeautyManager instead")
//    func setBeautyStyle(_ beautyStyle: TRTCBeautyStyle, beautyLevel: Int, whitenessLevel: Int, ruddinessLevel: Int){}
//    
//    
//    /**
...
//     */
//    @available(*, deprecated, message: "use getBeautyManager instead")
//    func setFaceVLevel(_ faceVLevel: Float){}
//    
//    
//    /**
...
//     */
//    @available(*, deprecated, message: "use getBeautyManager instead")
//    func setFaceShortLevel(_ faceShortlevel: Float){}
//    
//    
//    /**
...
//     */
//    @available(*, deprecated, message: "use getBeautyManager instead")
//    func setNoseSlimLevel(_ noseSlimLevel: Float){}
//    
//    
//    /**
...
//     */
//    @available(*, deprecated, message: "use getBeautyManager instead")
//    func selectMotionTmpl(_ tmplPath: String!){}
//    
//    
//    /**
...
//     */
//    @available(*, deprecated, message: "use getBeautyManager instead")
//    func setFilter(_ image: UIImage!){}
//    
//    
//    /**
//     * 15.13 设置滤镜浓度
...
//     */
//    @available(*, deprecated, message: "use getBeautyManager instead")
//    func setFilterConcentration(_ concentration: Float){}
//    
//    
//    /**
...
//     * @param file 视频文件路径。支持 MP4; nil 表示®关闭特效。
//     */
//    @available(*, deprecated, message: "use getBeautyManager instead")
